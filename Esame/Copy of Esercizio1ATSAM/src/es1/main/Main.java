...
public class Main {
	...
	private static void testA(){
		...
		System.out.println("Rectangle Perimeter: " + Math.round(statRectangle.getPerimeter()));
		System.out.println("Rectangle Area: " + Math.round(statRectangle.getArea()));
		System.out.println("EquilateralTriangle Perimeter: " + Math.round(statEquilateralTriangle.getPerimeter()));
		System.out.println("EquilateralTriangle Area: " + Math.round(statEquilateralTriangle.getArea()));
	}
